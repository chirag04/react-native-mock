...
var TouchableWithoutFeedback = _react2['default'].createClass({
  ...
  propTypes: {
    ...
    accessibilityTraits: _react2['default'].PropTypes.oneOfType([_react2['default'].PropTypes.oneOf(_View2['default'].AccessibilityTraits), _react2['default'].PropTypes.arrayOf(_react2['default'].PropTypes.oneOf(_View2['default'].AccessibilityTraits))]),
    /**
