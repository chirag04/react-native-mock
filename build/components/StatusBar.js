...
var StatusBar = _react2['default'].createClass({
  ...
  statics: {
    setBackgroundColor: function () {
      function setBackgroundColor(backgroundColor, animated) {
    ...
    setBarStyle: function () {
      function setBarStyle(barStyle, animated) {
        _barStyle = barStyle;
      }
    ...
    setHidden: function () {
      function setHidden(hidden, animated) {
        _hidden = hidden;
      }
    ...
    __getBackgroundColor: function () {
      function __getBackgroundColor() {
        return _backgroundColor;
      }

      return __getBackgroundColor;
    }(),
    __getBarStyle: function () {
      function __getBarStyle() {
        return _barStyle;
      }
    ...
    __getTranslucent: function () {
      function __getTranslucent() {
        return _translucent;
      }
